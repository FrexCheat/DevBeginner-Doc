export default function PycharmIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill='none' viewBox='0 0 64 64' {...props}>
      <defs>
        ...
        >
          <stop offset='0.1' stopColor='#00D886'></stop>
          <stop offset='0.59' stopColor='#F0EB18'></stop>
        </linearGradient>
        <linearGradient
          ...
          gradientUnits='userSpaceOnUse'
        >
          <stop offset='0.3' stopColor='#F0EB18'></stop>
          <stop offset='0.7' stopColor='#00C4F4'></stop>
        </linearGradient>
      </defs>
      <path
        fill='#00D886'
